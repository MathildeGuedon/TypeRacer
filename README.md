...
<img src="images/capture-ecran-hero-banner-typeracer-mots.jpg" alt="Aperçu d'une partie en mode défi avec des mots" title="Partie avec des mots" width="100%">
...
- <span style="color:blue"></></span> Mettre en oeuvre du **HTML/CSS**.
- <span style="color:gold">｡🇯‌🇸‌</span> Approfondir mes compétences en **JavaScript vanilla** (événements utilisateur, validation de formulaire, manipulation du DOM, gestion des popups).
...
<img src="images/capture-ecran-page-accueil-principal.png" alt="Paramétrage de la partie et boutons d'ouverture des popups" title="Ecran d'accueil : prêt à démarrer une partie" height="300">

### Popup de changement de joueur
<img src="images/capture-ecran-popup-choix-joueur-menu-deroulant.png" alt="menu déroulant modifiant le nom du joueur" title="Menu déroulant avec aide à la saisie non restrictive" height="300">

### Score, chronomètre et barre de score évolutifs en temps réel
<img src="images/capture-ecran-barre-score-temps-evolutif.png" alt="barre de score indiquant le nombre de saisies exactes, de propositions faites et de propositions restantes pour finir la partie" title="5 saisies exactes sur les 8 proposées en 15 secondes"  height="300">

### Popup des meilleurs scores
<img src="images/capture-ecran-popup-hall-of-fame.png" alt="tableau des 10 meilleurs scores" title="tableaux différents en fonction des choix de paramétrage de la partie" height="300">

### Popup de l'évolution des scores
<img src="images/capture-ecran-popup-evolution-score.png" alt="graphique des résultats d'un joueur en fonction du temps" title="Visualisation aisée de l'amélioration des résultats au fur et à mesure des parties" height="300">
